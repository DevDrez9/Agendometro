...
Future<Pago?> showFullScreenPagar(BuildContext context, String servicio,
    String especialista, String cliente, String total, int tipoAccion) async {
  TextEditingController montoPagoController = TextEditingController();
  final _formKeyPago = GlobalKey<FormState>();

  return await showDialog<Pago>(
    context: context,
